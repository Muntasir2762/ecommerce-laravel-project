                        ...
                        <div class="filter-items-wrapper">
                            ...
                            <div class="filter-items-outer">
                                ...
                                <form class="filter-items" id="collapseOne" action="{{url('/shop')}}" method="GET">
                                    ...
                                    <div class="item-label">
                                        <label>
                                            <input type="checkbox" value="{{$category->id}}" onclick="formSubmitCategory()" id="cat_id" name="cat_id" class="checkbox" />
                            ...
                            <div class="filter-items-outer">
                                ...
                                <form class="filter-items" id="collapseTwo" action="{{url('/shop')}}" method="GET">
                                    ...
                                    <div class="item-label">
                                        <label>
                                            <input type="checkbox" value="{{$subCategory->id}}" onclick="formSubmitSubCategory()" id="subcat_id" name="subcat_id" class="checkbox" />
                                            <span>
                                                {{$subCategory->name}}
                                            </span>
                                        </label>
